...
ggplot(summary_table_desc, aes(x = factor(description), y = Frequency)) + 
...
ggplot(summary_table_zip, aes(x = factor(zipcode), y = Frequency)) + 
...
# Visualize
ggplot(zip_data, aes(x = median_income, y = Frequency)) +
  geom_point() +
