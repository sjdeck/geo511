...
With the above table, it is determined that for every $1,000 increase in median income, call volume will decrease by roughly 12 calls. This can be visualized through the graph created earlier. 
